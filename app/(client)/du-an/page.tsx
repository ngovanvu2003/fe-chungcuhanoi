      ...
      <div className="md:flex flex-col md:flex-row">
        <div>
          ...
          <div className="">
            <div className="lg:max-w-3xl">
              ...
              <div className="mx-auto border-1 p-4 shadow-inner">
                ...
                <div className="text-detail">
                  ...
                  nội thất giá 1,8 tỷ. - Căn 2PN 1WC (51m²) full nội thất giá
                  2.4 tỷ. - Căn 2PN 1WC (61m²) full nội thất giá 2.6 tỷ. - Căn
                  2PN 2WC (72m²) full nội thất giá 4.3 tỷ - Căn 2PN 2WC (85m²)
                  full nội thất giá 4.8 tỷ. - Căn 3PN (95m²) full nội thất giá
                  từ 5.95 tỷ. - Căn 3PN (112m²) full nội thất giá từ 6.6 tỷ -
                  Đặc biệt, căn rộng nhất dự án (122m²) full nội thất giá từ 7.8
                  tỷ Tham khảo thêm các c...
                </div>
              </div>
            ...
            {/* Project */}
            <div className="lg:max-w-3xl mt-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 border-2 ">
                <img
                  src="https://file4.batdongsan.com.vn/crop/562x284/2023/09/28/20230928101136-0965_wm.jpg"
                  alt=""
