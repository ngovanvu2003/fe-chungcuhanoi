    ...
    return (
        <div>
            <div className='@apply border mb-4 p-[15px] rounded-lg border-solid border-[#F2F2F2] bg-[#F2F2F2]'>
                <a href="#">
                    <h2 className='@apply text-[#323232] block mb-4 font-medium '>Nhà môi giới trong khu vực </h2>
                    <div className='@apply flex justify-center items-center mb-4'>
                        ...
                        <div className='w-[77%]'>
                            ...
                            <span className='@apply text-sm leading-5 font-[normal] text-[#999] block'>0915221443</span>
                        </div>
                    </div>
                    <div className='@apply flex justify-center items-center mb-4'>
                        <Avatar className='mr-3'>
                        ...
                        <div className='w-[77%]'>
                            ...
                            <span className='@apply text-sm leading-5 font-[normal] text-[#999] block'>0934543563</span>
                        </div>
                    </div>
                    <div className='@apply flex justify-center items-center mb-4'>
                        <Avatar className='mr-3'>
                        ...
                        <div className='w-[77%]'>
                            ...
                            <span className='@apply text-sm leading-5 font-[normal] text-[#999] block'>0908611638</span>
                        </div>
                    </div>
                </a>
            </div>
