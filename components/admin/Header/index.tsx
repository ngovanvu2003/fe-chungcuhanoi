...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-20 2xl:px-11">
          ...
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              ...
              <input
                ...
                className=" bg-transparent font-medium focus:outline-none border px-2 py-2 w-[400px] border-solid border-blue-500 rounded"
              />
            </div>
          </form>
        </div>
